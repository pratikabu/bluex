...
<title>Test Center- Extremity</title>
<style type="text/css">
<!--
        ...
        <td bgcolor="#F8F8F8"><table width="100%"  border="0">
              ...
              <tr>
                <td><table width="100%"  border="1">
                    ...
                    <%
                    com.gmail.pratikabu.extremity.components.TestLineGenerator tlg=
                            new com.gmail.pratikabu.extremity.components.TestLineGenerator();
                    %>
                    <%= tlg.generateTestLines(request.getParameter("txtSearch")) %>
                </table></td>
              </tr>
          </table></td>
        </tr>
