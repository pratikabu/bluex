                  ...
                  <td><table width="100%"  border="0" bgcolor="#F8F8F8">
                      <tr>
                        <td><div align="center">
                          ...
                          <p>Username already exists. Please try again with different username.</p>
                            <br/>
                            <a href="/Extremity/StudentRegistration.jsp">Click here</a> to go to registration page.</div></td>
                      </tr>
                  </table></td>
                </tr>
            </table></td>
